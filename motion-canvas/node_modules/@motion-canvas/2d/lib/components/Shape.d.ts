...
export declare abstract class Shape extends Layout {
    ...
    ripple(duration?: number): Generator<void | import("@motion-canvas/core/lib/threading").ThreadGenerator | Promise<any> | import("@motion-canvas/core/lib/threading").Promisable<any>, void, any>;
}
