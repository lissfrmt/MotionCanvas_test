...
import { Origin, PossibleSpacing, PossibleVector2, BBox, SerializedVector2, SpacingSignal, Vector2, Vector2Signal } from '@motion-canvas/core/lib/types';
...
export declare class Layout extends Node {
    ...
    protected readonly customX: SimpleSignal<number, this>;
    protected getX(): number;
    protected setX(value: SignalValue<number>): void;
    protected readonly customY: SimpleSignal<number, this>;
    ...
    protected readonly customWidth: SimpleSignal<DesiredLength, this>;
    ...
    protected readonly customHeight: SimpleSignal<DesiredLength, this>;
    ...
    protected readonly sizeLockCounter: SimpleSignal<number, void>;
    constructor({ tagName, ...props }: LayoutProps);
    lockSize(): void;
    releaseSize(): void;
