        ...
        async load(id) {
            ...
            if (query) {
                ...
                if (params.has('project')) {
                    ...
                    return source(...imports, `import {ProjectMetadata} from '@motion-canvas/core/lib/app';`, `import metaFile from './${metaFile}';`, `import config from './${name}';`, `const project = {`, `  name: '${name}',`, `  versions: ${versions},`, `  ...config,`, `  plugins: [${pluginNames.join(', ')}],`, `};`, `project.meta = new ProjectMetadata(project);`, `metaFile.attach(project.meta)`, `export default project;`);
                }
            }
        },
